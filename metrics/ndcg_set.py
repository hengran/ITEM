...
for file_name in file_list:
    ...
    for k in [1,2,3,4,5,6]:
        ...
        for line in file:
            ...
            # if js["question"] in data_non_fact: ##只有事实类
            #     continue
            ...
            temp = js["model_out_labels"][min(k-1, len(js["utility_labels"])-1)]
            ground_truth_label = js["utility_labels"][min(k-1, len(js["utility_labels"])-1)]
...
# 保存工作簿
wb.save('metrics_webap-relevance-output_ndcg.xlsx')
