...
def generate_answer_prompt(question, passages):
    pas = '\n'.join(passages)
    return [{'role': 'user', 'content': f"You are a faithful question and answer assistant. Answer the question based on the given information and your internal knowledge  with one or few sentences without the source."}, 
            {'role': 'assistant', 'content': 'Yes, i am the faithful question and answer assistant.'}, 
            {'role': 'user', 'content': f"Given the information: \n{pas}\n Answer the following question based on the given information and your internal knowledge with one or few sentences without the source.\n Question: {question}\n\n Answer:"},]
...
if __name__ == '__main__':
    ...
    """
    main("webap", llm, tokenizer, instruct, "-iter-passages-point-add-ref-", 0, sampling_params, -1, 0)
