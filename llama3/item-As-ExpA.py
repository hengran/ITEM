...
if __name__ == '__main__':
    ...
    tokenizer = transformers.AutoTokenizer.from_pretrained("models/llama3_8b_instruct/")
    llm = LLM(model="models/llama3_8b_instruct/")
    instruct = """
    ...
    """
    main_list("trec", llm, tokenizer, instruct, "-iter-passages-list88-", 0, sampling_params, -1, 0)
    main_list("webap", llm, tokenizer, instruct, "-iter-passages-list88-", 0, sampling_params, -1, 0)
    ...
    main("webap", llm, tokenizer, instruct, "-iter-passages-point-add-ref88-", 0, sampling_params, -1, 0)
    main("trec", llm, tokenizer, instruct, "-iter-passages-point-add-ref88-", 0, sampling_params, -1, 0)
